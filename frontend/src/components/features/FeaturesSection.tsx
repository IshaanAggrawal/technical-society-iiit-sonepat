    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          ...
          <br />
          <span className="text-gradient font-medium">Through Technology & Collaboration</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          The Technical Society of IIIT Sonepat is the official hub for all tech enthusiasts — uniting developers, innovators, and creators across diverse technical domains. Explore our clubs, projects, and initiatives driving innovation on campus.
        </p>
      </div>
