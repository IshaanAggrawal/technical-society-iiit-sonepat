...
// 1. Import 'dynamic' from 'next/dynamic' (removed 'lazy')
...
// 2. Use 'next/dynamic' to import your canvas with SSR disabled
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* 3. The <Suspense> wrapper is no longer needed here
            because 'loading' is handled in the dynamic import */}
